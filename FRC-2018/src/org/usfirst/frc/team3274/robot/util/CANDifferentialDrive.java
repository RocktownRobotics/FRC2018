...
/**
 * Based off of WPLIB's Differential Drive but configured for CAN motors.
 * 
 * @author AJ Snarr
 * @author Ian McGary
 *
 */
public class CANDifferentialDrive extends CANDriveBase {
	...
	/**
	   ...
	   */
	  public CANDifferentialDrive(BaseMotorController leftMotor, BaseMotorController rightMotor) {
