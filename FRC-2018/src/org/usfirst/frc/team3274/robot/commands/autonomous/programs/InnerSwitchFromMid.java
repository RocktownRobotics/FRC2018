...
import org.usfirst.frc.team3274.robot.commands.autonomous.groups.MidToInnerLeft;
import org.usfirst.frc.team3274.robot.commands.autonomous.groups.MidToInnerRight;

import edu.wpi.first.wpilibj.DriverStation;
import edu.wpi.first.wpilibj.command.CommandGroup;

public class InnerSwitchFromMid extends CommandGroup {
...
//		addSequential(new ShiftDownForTime());
		...
		if (this.switchIsRight()) {
			// mid to Right Switch
			addSequential(new MidToInnerRight());
			addSequential(new InnerRightToSwitch());
		} else {
			// Mid to Left Switch
